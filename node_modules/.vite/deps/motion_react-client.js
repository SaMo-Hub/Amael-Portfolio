...
function canAnimate(keyframes2, name, type, velocity) {
  ...
  return hasKeyframesChanged(keyframes2) || (type === "spring" || (void 0)(type)) && velocity;
}
...
var BaseAnimation = class {
  ...
  onKeyframesResolved(keyframes2, finalKeyframe) {
    ...
    const { name, type, velocity, delay: delay2, onComplete, onUpdate, isGenerator: isGenerator4 } = this.options;
...
function spring(optionsOrVisualDuration = springDefaults.visualDuration, bounce = springDefaults.bounce) {
  ...
  const generator = {
    ...
    toString: () => {
      const calculatedDuration = Math.min((void 0)(generator), void 0);
...
var MainThreadAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes$1) {
    ...
    const generatorFactory = (void 0)(type) ? type : generators[type] || keyframes;
    ...
    if (generator.calculatedDuration === null) {
      generator.calculatedDuration = (void 0)(generator);
    }
...
var supportsLinearEasing = (void 0)(() => {
  try {
...
function requiresPregeneratedKeyframes(options) {
  return (void 0)(options.type) || options.type === "spring" || !isWaapiSupportedEasing(options.ease);
}
    ...
    const onStart = (event, info) => {
      ...
      if (drag2 && !dragPropagation) {
        if (this.openDragLock)
          this.openDragLock();
        this.openDragLock = (void 0)(drag2);
        if (!this.openDragLock)
          return;
      }
...
function press(elementOrSelector, onPressStart, options = {}) {
  ...
  const startPress = (startEvent) => {
    ...
    if (!isValidPressEvent(startEvent) || (void 0).has(element))
      return;
    (void 0).add(element);
    ...
    const onPointerEnd = (endEvent, success) => {
      ...
      if (!isValidPressEvent(endEvent) || !(void 0).has(element)) {
        return;
      }
      (void 0).delete(element);
      if (onPressEnd) {
  ...
  elements.forEach((element) => {
    ...
    element.addEventListener("focus", (event) => (void 0)(event, eventOptions), eventOptions);
  });
  return cancelEvents;
}
...
var InViewFeature = class extends Feature {
  ...
  startObserver() {
    ...
    return (void 0)(this.node.current, options, onIntersectionUpdate);
  }
  mount() {
    this.startObserver();
  }
